...
relatedFiles: ["/home/ivan/.pi/README.md"]
...
Review position 2, following dotfiles first and then README order as agreed with Algorant. GitHub: https://github.com/Algorant/pi (visibility at inventory: private). Authoritative checkout: /home/ivan/.pi; origin verified. The profile README describes the intended public presentation. Use the common rubric in docs/public-readiness.md, conduct the review with Algorant, and agree on concrete remediation after findings. This Task coordinates the outcome; implementation belongs in the referenced repository under its own instructions. This is the canonical shared Pi configuration checkout, not a duplicate under Projects. Installed configuration and runtime state require careful separation; do not edit live resources during the initial review.
